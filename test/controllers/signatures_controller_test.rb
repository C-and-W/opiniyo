...
class SignaturesControllerTest < ActionController::TestCase
  ...
  test "should create signature" do
    assert_difference('Signature.count') do
      post :create, signature: { age: @signature.age, email: @signature.email, name: @signature.name, id: @signature.id }
    end
  ...
  test "should update signature" do
    patch :update, id: @signature, signature: { age: @signature.age, email: @signature.email, name: @signature.name, id: @signature.id }
    assert_redirected_to signature_path(assigns(:signature))
  end
